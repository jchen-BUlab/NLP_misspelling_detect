# Adapted from CharacterBERT and Hugging Face Transformers:
    ...
    def forward(
        ...
        **kwargs
        ...
        if inputs_embeds is not None:
            raise ValueError(
                "CharacterBertModel requires character input_ids and does not accept inputs_embeds"
            )
        if input_ids is None:
            raise ValueError("CharacterBertModel requires character input_ids")
